 ...
 * \brief fichier qui implemente les fonctions de validations des numeros de vehicules
 *
 * \date Oct 3, 2016
...
namespace util
{
	 ...
	 * \return un boolein vrai si l'immatriculation est valide, sinon faux
	  */
	...
	/**
	 * \brief fonction qui valide une plaque d'immatriculation pour un camion
	 * \param[in] p_immatriculation une chaine de caractere a tester
	 * \return un boolein vrai si l'immatriculation est valide, sinon faux
	 */
	bool validerImmatriculationCamion(const std::string& p_immatriculation)
	{
			return(validerPattern(p_immatriculation,"L000000","L999999"));
	}

	/**
	 * \brief fonction qui valide une plaque d'immatriculation pour un vehicule de promenade
	 * \param[in] p_immatriculation une chaine de caractere a tester
	 * \return un boolein vrai si l'immatriculation est valide, sinon faux
	 */
	 ...
	 * \return Un boolein vrai si le numero de serie est valide
	*/
	 ...
	 * \return un boolein vrai si le numero d'identification a le bon numero de validation
	*/
	...
	/**
	 * \brief  fonction qui retourne la valeur du caractere de validation
	 * \param[in] p_niv une string contenant un numero d'identification
	 * \return Un entier qui est le chiffre validateur du numero d'identification
	 */
	 ...
	 * \param[in] p_niv une chaine de caractere contenant le numero de validation a tester
	 * \return un boolein qui retourne vrai si le numero contient une erreur
	*/
	 ...
	 * \param[in] p_niv une chaine de caractere contenant le numero de validation a tester
	 * \return un boolein vrai si le numero contient une erreur
	*/
	 ...
	 * \return un boolein vrai si le pattern en input a ete trouve
	*/
	...
	*/
	...
	/**
	 * \brief Fonction qui retourne le reste d'une division entiere
	 * \param[in] p_nombreADiviser le nombre a diviser
	 * \param[in] p_diviseur le nombre qui divise le nombre a diviser
	 * \return un entier contenant le reste de la division entiere
	 */
	 ...
	 * return un entier qui aggrege les valeurs par leurs poids respectifs
	 */
